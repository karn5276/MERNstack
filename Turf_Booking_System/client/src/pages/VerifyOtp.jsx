...
const VerifyOtp = () => {
    ...
    const handleOnSubmit = (e) => {
        ...
        e.preventDefault();
        const { email, accountType, password, lastName, firstName } = signupData;
                ...
                <div className='min-h-[calc(100vh-3.5rem)] grid place-items-center'>
                    <div className='max-w-[500px] p-4 lg:p-8'>
                        ...
                        <form onSubmit={handleOnSubmit}>
                            ...
                            />
                            <button type="submit" className="w-full bg-green-500 py-[12px] px-[12px] rounded-[8px] mt-6 font-medium text-richblack-900">Verify Email</button>
                        </form>
